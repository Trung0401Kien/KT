    ...
    public class Common
    {
            ...
            string toMail)
        {
            ...
            try
            {
                ...
                {
                    smtp.Host = "smtp.gmail.com"; //ĐỊA CHỈ SMTP Server
                    smtp.Port = 587; //Cổng SMTP
                    smtp.EnableSsl = true; //SMTP yêu cầu mã hóa dữ liệu theo SSL
                    smtp.DeliveryMethod = System.Net.Mail.SmtpDeliveryMethod.Network;

                    smtp.UseDefaultCredentials = false;
                    smtp.Credentials = new NetworkCredential() //UserName và Password của mail
                    {
                        UserName = Email,
                        Password = password
                    };
